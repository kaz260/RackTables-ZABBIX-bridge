...
# Top
$rowindex = array();
$page['top']['parent'] = 'index';
$page['top']['title'] = 'Top';
#$tab['top']['default'] = 'Top';
#$tab['top']['edit'] = 'Edit';
#$tabhandler['top']['default'] = 'renderTop';
$tabhandler['top']['edit'] = 'renderTopEdit';
$ophandler['top']['edit']['updateObjectAllocation'] = 'topUpdateObjectAllocation';
$tabhandler['top']['edititems'] = 'renderTopEditItems';
$ophandler['top']['edititems']['updateObjectItems'] = 'updateObjectItems';
$tabhandler['top']['airshiny'] = 'renderTopAirShiny';

# Item
$page['item']['parent'] = 'index';
$page['item']['title'] = 'Items';
$tab['item']['default'] = 'View';
$tabhandler['item']['default'] = 'renderItem';
$ophandler['item']['default']['viewitems'] = 'itemViewItems';
$tab['item']['properties'] = 'Edit Item';
$tabhandler['item']['properties'] = 'renderTopEditItems';
$ophandler['item']['properties']['updateObjectItems'] = 'updateObjectItems';
